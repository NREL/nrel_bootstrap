...
NREL Boostrap has a dependency on https://github.com/NatLabRockies/nrel-app-template-bootstrap4 to ease the update process when the base theme changes.

Find out more about the standards at https://www.nlr.gov/comm-standards/web/application.
...
Run the NREL Bootstrap post install commands from the root project to copy the Bootstrap library and the JS, CSS and images used in the NLR Application theme to the correct places for use in NREL Bootstrap.
